"""
rApp: builder_46dff16766
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Generated by Naavik AppGen – Conversational Builder V1
thread_id   : 46dff167-6616-4265-adb1-268bb0d141c1
intent      : optimization
runtime     : EIAP
...
Parameter Actions:
  • set neighborRelation.cellIndividualOffset by 5

Scope       : any 4G cell meeting threshold
Granularity : hourly
Generated   : 2026-02-19T20:59:01.806Z
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
logger = logging.getLogger("builder_46dff16766")

# ── Constants ────────────────────────────────────────────────────────
APP_NAME = "builder_46dff16766"
APP_VERSION = "1.0.0"
TARGET_PLATFORM = "ERICSSON_ENM"
GRANULARITY = "hourly"
SCOPE_DESCRIPTION = "any 4G cell meeting threshold"

KPI_CONDITIONS = [{"name":"RRC FAIL","op":">=","threshold":5}]
PARAMETER_ACTIONS = [{"param":"cellIndividualOffset","mo":"neighborRelation","type":"set","val":5}]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="builder_46dff16766 – Naavik rApp")
    parser.add_argument("--dry-run", action="store_true", help="Preview changes without applying")
    parser.add_argument("--output", type=str, default=None, help="Write report JSON to file")
    args = parser.parse_args()

    app = builder_46dff16766(dry_run=args.dry_run or DRY_RUN)
    result = app.execute()
