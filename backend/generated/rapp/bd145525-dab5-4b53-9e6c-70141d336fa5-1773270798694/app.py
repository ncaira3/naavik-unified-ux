"""
rApp: builder_bd145525da
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Generated by Naavik AppGen – Conversational Builder V1
thread_id   : bd145525-dab5-4b53-9e6c-70141d336fa5
intent      : optimization
runtime     : EIAP
platform    : ERICSSON_EIAP

KPI Conditions:
  • PRB Utilization < 50%

Parameter Actions:
  • set EUtranCellRelation.cellIndividualOffset by 1

Scope       : any 4G cell meeting threshold
Granularity : hourly
Generated   : 2026-03-11T23:13:18.694Z
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
logger = logging.getLogger("builder_bd145525da")

# ── Constants ────────────────────────────────────────────────────────
APP_NAME = "builder_bd145525da"
APP_VERSION = "1.0.0"
TARGET_PLATFORM = "ERICSSON_EIAP"
GRANULARITY = "hourly"
SCOPE_DESCRIPTION = "any 4G cell meeting threshold"

KPI_CONDITIONS = [{"name":"PRB Utilization","op":"<","threshold":50}]
PARAMETER_ACTIONS = [{"param":"cellIndividualOffset","mo":"EUtranCellRelation","type":"set","val":1}]

R1_ENTITY_ENDPOINT = (
    "/domains/RAN/entity-types/EUtranCellRelation/entities"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="builder_bd145525da – Naavik rApp")
    parser.add_argument("--dry-run", action="store_true", help="Preview changes without applying")
    parser.add_argument("--output", type=str, default=None, help="Write report JSON to file")
    args = parser.parse_args()

    app = builder_bd145525da(dry_run=args.dry_run or DRY_RUN)
    result = app.execute()
