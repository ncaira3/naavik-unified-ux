"""
rApp: builder_c0477dce1a
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Generated by Naavik AppGen – Conversational Builder V1
thread_id   : c0477dce-1ab0-4da1-9900-89e678b62fff
intent      : optimization
runtime     : EIAP
...
Parameter Actions:
  • set neighborRelation.cellIndividualOffset by 3

Scope       : any 4G cell meeting threshold
Granularity : hourly
Generated   : 2026-02-20T08:20:30.015Z
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
logger = logging.getLogger("builder_c0477dce1a")

# ── Constants ────────────────────────────────────────────────────────
APP_NAME = "builder_c0477dce1a"
APP_VERSION = "1.0.0"
TARGET_PLATFORM = "ERICSSON_ENM"
GRANULARITY = "hourly"
SCOPE_DESCRIPTION = "any 4G cell meeting threshold"

KPI_CONDITIONS = [{"name":"RRC Fail","op":">","threshold":10}]
PARAMETER_ACTIONS = [{"param":"cellIndividualOffset","mo":"neighborRelation","type":"set","val":3}]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="builder_c0477dce1a – Naavik rApp")
    parser.add_argument("--dry-run", action="store_true", help="Preview changes without applying")
    parser.add_argument("--output", type=str, default=None, help="Write report JSON to file")
    args = parser.parse_args()

    app = builder_c0477dce1a(dry_run=args.dry_run or DRY_RUN)
    result = app.execute()
